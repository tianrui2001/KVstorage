...
const char descriptor_table_protodef_raftRPC_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ncludeIndex\030\004 \001(\005\022\037\n\027LastSnapShotInclude"
  "Term\030\005 \001(\005\022\014\n\004Data\030\003 \001(\014\"\'\n\027InstallSnaps"
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        ...
        continue;
      // int32 LastSnapShotIncludeIndex = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
        ...
        continue;
      // int32 LastSnapShotIncludeTerm = 5;
      case 5:
...
::PROTOBUF_NAMESPACE_ID::uint8* InstallSnapshotRequest::_InternalSerialize(
  ...
  if (this->lastsnapshotincludeindex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_lastsnapshotincludeindex(), target);
  }

  // int32 LastSnapShotIncludeTerm = 5;
  if (this->lastsnapshotincludeterm() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_lastsnapshotincludeterm(), target);
  }
